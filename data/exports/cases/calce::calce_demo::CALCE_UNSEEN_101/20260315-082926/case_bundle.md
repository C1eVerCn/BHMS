...
## 三、历史轨迹摘要
- 已读取 cycle 点：30
- 首个 cycle：1，容量 1.9380Ah
- 最新 cycle：30，容量 1.5900Ah
...
- 关键特征 temperature_mean: 遮挡 temperature_mean 后，模型输出相对基线压低了 RUL 估计。
- 关键特征 capacity: 遮挡 capacity 后，模型输出相对基线压低了 RUL 估计。
...
- 实验风险：hybrid 的 MAPE 偏高，建议补充多随机种子与消融实验。
